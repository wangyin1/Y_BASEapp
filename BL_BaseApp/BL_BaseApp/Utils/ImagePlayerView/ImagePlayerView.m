...
//#import "WGoodsDetailVC.h"
//#import "WGoodsListVC.h"
...
- (void)_init
{
    ...
    [self addSubview:self.scrollView];
     self.scrollView.layer.contents = (id)[UIImage imageNamed:@"保养banner.png"].CGImage;
    ...
    [self setPageControlPosition: ICPageControlPosition_BottomCenter];
    //-------------
}
...
//            if ([data[@"types"] integerValue]==1) {
//                
//                BaseViewController *vc = [[BaseViewController alloc]init];
//                vc.title = data[@"ad_name"];
//                vc.hidesBottomBarWhenPushed = YES;
//                UIWebView *web = [[UIWebView alloc]initWithFrame:CGRectMake(0, 0, ScreenWith, ScreenHight-64)];
//                NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:data[@"link"]]];
//                [web loadRequest:req];
//                [vc.view addSubview:web];
//                [((UIViewController *)self.imagePlayerViewDelegate).navigationController pushViewController:vc animated:YES];
//                
//            }else if ([data[@"types"] integerValue]==2){
//                WGoodsDetailVC *vc = [[WGoodsDetailVC alloc]init];
//                vc.goodsID = data[@"link"];
//                vc.hidesBottomBarWhenPushed = YES;
//                 [((UIViewController *)self.imagePlayerViewDelegate).navigationController pushViewController:vc animated:YES];
//            }else if([data[@"types"] integerValue]==3){
//               
//                WGoodsListVC *vc =[[WGoodsListVC alloc]init];
//                vc.cid = data[@"link"];
//                vc.hidesBottomBarWhenPushed = YES;
//                [((UIViewController *)self.imagePlayerViewDelegate).navigationController pushViewController:vc animated:YES];
//            }else{
//                //跳转到活动
//                WActiveVC *vc = [[WActiveVC alloc]init];
//                vc.data = data;
//                vc.hidesBottomBarWhenPushed = YES;
//                [((UIViewController *)self.imagePlayerViewDelegate).navigationController pushViewController:vc animated:YES];
//            }
