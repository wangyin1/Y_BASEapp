...
+ (void)showWithStr:(NSString *)str WithTime:(CGFloat)time{
    JGProgressHUD *hud = [[JGProgressHUD alloc]initWithStyle:2];
    [hud showInView:[[[[UIApplication sharedApplication]delegate]window] currentViewController].view UseprogressIndicatorView:NO];
...
- (void)showInView:(UIView *)view UseprogressIndicatorView:(BOOL)use{
    self.useProgressIndicatorView = use;
    self.userInteractionEnabled = NO;
    [self showInRect:view.bounds inView:view animated:YES];
}
