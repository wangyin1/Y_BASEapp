...
- (void)sd_setImageWithURL:(NSURL *)url {
    [self sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"goods_pic-1"] options:0 progress:nil completed:nil];
}

- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder {
    

    [self sd_setImageWithURL:url placeholderImage:placeholder?placeholder:[UIImage imageNamed:@"goods_pic-1"] options:0 progress:nil completed:nil];
}
...
- (void)sd_setImageWithURL:(NSURL *)url completed:(SDWebImageCompletionBlock)completedBlock {
    [self sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"goods_pic-1"]  options:0 progress:nil completed:completedBlock];
}
