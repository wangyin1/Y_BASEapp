...
//  UIView-ZQuartz
//
//  Created by zhuayi on 15/5/19.
//  Copyright (c) 2015年 zhuayi. All rights reserved.
//

#import "UIImage+ZQuartz.h"

#define PI 3.1415926
@implementation UIImage (ZQuartz)
 ...
 */
- (void)drawText:(CGRect)rect text:(NSString *)text fontSize:(NSDictionary *)fontStyle
{
    // 兼容不同长度的字符串
    [text drawInRect:rect withAttributes:fontStyle];
