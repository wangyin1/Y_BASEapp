...
- (void)setCanvasDelay:(CGFloat)canvasDelay{
    objc_setAssociatedObject(self, @selector(canvasDelay), @(canvasDelay), OBJC_ASSOCIATION_ASSIGN);
...
- (void)setCanvasDuration:(CGFloat)canvasDuration{
    objc_setAssociatedObject(self, @selector(canvasDuration), @(canvasDuration), OBJC_ASSOCIATION_ASSIGN);
